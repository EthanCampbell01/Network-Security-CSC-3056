...
public class Account {
    ...
    public String toString() {
        String dateStr = new SimpleDateFormat("dd/MM/yyyy").format(account_opening_date);
        // formatted to match SimpleBankingApp.printAllAccounts() header widths
        return String.format("%-10s| %-30s| %-10s| %-15s",
                account_number, username_of_account_holder, account_type, dateStr);
    }
}